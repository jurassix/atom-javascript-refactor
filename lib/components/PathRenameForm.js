...
class PathRenameForm extends React.Component {
  ...
  render() {
    return (
      <div ref={ref => { this.root = ref; }} className="atom-refactoring-codemods">
        <label
          className="icon icon-arrow-right"
          htmlFor="atom-refactoring-codemods-path-rename-input"
        >
          Enter the new path for the file.
        </label>
        <AtomInput
          id="atom-refactoring-codemods-path-rename-input"
