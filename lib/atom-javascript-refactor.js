...
import getPathFromContextMenuTarget from './utils/getPathFromContextMenuTarget';
...
export default {
  ...
  consumeStatusBar(statusBar: atom$StatusBar) {
    this.statusBarTile = new StatusBarTile(this.store);
  ...
  refactor(e: Event) {
    ...
    const previousPath = getPathFromContextMenuTarget(e.target);
